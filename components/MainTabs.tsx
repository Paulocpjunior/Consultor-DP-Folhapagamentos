...
import ExtratosPanel from './extratos/ExtratosPanel';
...
type Tab = 'folha' | 'empresas' | 'esocial' | 'extratos' | 'admin';
...
const MainTabs: React.FC<{ children?: React.ReactNode }> = () => {
    ...
    const tabs: { id: Tab; label: string; icon: string; adminOnly: boolean }[] = [
        ...
        { id: 'extratos', label: 'Extratos',  icon: '🏦', adminOnly: false },
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
            ...
            <main className="max-w-7xl mx-auto p-4 sm:p-6">
                ...
                {activeTab === 'extratos' && <ExtratosPanel currentUser={currentUser as any} />}
